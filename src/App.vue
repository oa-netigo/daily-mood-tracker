<template>
  <section class="bg-white py-8 antialiased dark:bg-gray-900">
    <div class="mx-auto grid max-w-screen-xl md:grid-cols-12 lg:gap-12 xl:gap-0 px-4 2xl:px-0">
      <div class="content-center justify-self-start md:col-span-8 md:text-start">
  ...
  <section class="bg-white pb-16 antialiased dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
        <div id="mpod-form" class="min-w-0 flex-1 space-y-8 sticky top-0 lg:top-4 z-index-1 bg-white">
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4">
              <div>
                ...
                <select id="mood" v-model="newMood.mood" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500">
              ...
              <div>
                ...
                <textarea id="note" v-model="newMood.note" placeholder="How was your day?" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"></textarea>
              </div>
              <button @click="saveMood" :disabled="!newMood.mood" class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Save mood
              </button>
            </div>
          </div>
        </div>
        <div id="mood-history" class="mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
            Your mood history:
          </h2>
          <div id="mood-list" v-if="moodEntries.length > 0" class="flex flex-col gap-4">
